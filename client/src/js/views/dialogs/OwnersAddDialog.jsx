...
const HELP_TEXT = {
  prefix:
    "This field must include only letters, up to 7 characters and be unique across all owners",
  residency:
  ...
  isValid = () => {
    ...
    if (isBlank(this.state.name)) {
      ...
      var other = _.find(
        ...
        (other) =>
          other.organizationName.toLowerCase().trim() === nameIgnoreCase
      );
      if (other) {
        this.setState({
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <FormGroup
          controlId="givenName"
          validationState={this.state.ownerGivenNameError ? "error" : null}
        >
          <ControlLabel>
        ...
        <FormGroup
          controlId="surname"
          validationState={this.state.ownerSurameError ? "error" : null}
        >
          <ControlLabel>
        ...
        <FormGroup
          controlId="address1"
          validationState={this.state.address1Error ? "error" : null}
        >
          <ControlLabel>
        ...
        <FormGroup
          controlId="city"
          validationState={this.state.cityError ? "error" : null}
        >
          <ControlLabel>
            City <sup>*</sup>
          </ControlLabel>
        ...
        <FormGroup
          controlId="province"
          validationState={this.state.provinceError ? "error" : null}
        >
          <ControlLabel>
            Province <sup>*</sup>
          </ControlLabel>
        ...
        <FormGroup
          ...
          validationState={this.state.postalCodeError ? "error" : null}
        >
          <ControlLabel>
            Postal Code <sup>*</sup>
          </ControlLabel>
        ...
        <FormGroup
          controlId="ownerCode"
          validationState={this.state.ownerCodeError ? "error" : null}
        >
          <ControlLabel>
            Owner Code <sup>*</sup>
          </ControlLabel>
        ...
        <FormGroup
          ...
          validationState={
            this.state.workSafeBCPolicyNumberError ? "error" : null
          }
        >
          <ControlLabel>
            WCB Number <sup>*</sup>
        ...
        <FormGroup
          ...
          validationState={
            this.state.primaryContactGivenNameError ? "error" : null
          }
        >
          <ControlLabel>
        ...
        <FormGroup controlId="primaryContactSurname">
          ...
          <FormInputControl
            type="text"
            value={this.state.primaryContactSurname}
            updateState={this.updateState}
          />
        </FormGroup>
        <FormGroup
        ...
        <FormGroup controlId="primaryContactRole">
          ...
          <FormInputControl
            type="text"
            value={this.state.primaryContactRole}
            updateState={this.updateState}
          />
        </FormGroup>
        <FormGroup
          controlId="status"
          validationState={this.state.projectStatusCodeError ? "error" : null}
        >
        ...
        <FormGroup controlId="registeredCompanyNumber">
          ...
          <FormInputControl
            type="text"
            value={this.state.registeredCompanyNumber}
            updateState={this.updateState}
          />
        </FormGroup>
        ...
        <FormGroup
          controlId="meetsResidency"
          validationState={this.state.residencyError ? "error" : null}
        >
          <CheckboxControl
            id="meetsResidency"
