...
namespace HETSAPI.Test
{
    ...
    public class DumpTruckModelTests
    {
        ...
        /// <summary>
        /// Test the property 'IsSingleAxle'
        /// </summary>
        [Fact]
        public void IsSingleAxleTest()
        {
            // TODO unit test for the property 'IsSingleAxle'
			Assert.True(true);
        }
        /// <summary>
        /// Test the property 'IsTandemAxle'
        /// </summary>
        [Fact]
        public void IsTandemAxleTest()
        {
            // TODO unit test for the property 'IsTandemAxle'
			Assert.True(true);
        }
        /// <summary>
        /// Test the property 'IsTridem'
        /// </summary>
        [Fact]
        public void IsTridemTest()
        {
            // TODO unit test for the property 'IsTridem'
			Assert.True(true);
        }
        /// <summary>
        /// Test the property 'HasPUP'
        /// </summary>
        [Fact]
        public void HasPUPTest()
        {
            // TODO unit test for the property 'HasPUP'
			Assert.True(true);
        }
        /// <summary>
        /// Test the property 'HasBellyDump'
        /// </summary>
        [Fact]
        public void HasBellyDumpTest()
        {
            // TODO unit test for the property 'HasBellyDump'
			Assert.True(true);
        }
        /// <summary>
        /// Test the property 'HasRockBox'
        /// </summary>
        [Fact]
        public void HasRockBoxTest()
        {
            // TODO unit test for the property 'HasRockBox'
			Assert.True(true);
        }
        /// <summary>
        /// Test the property 'HasHiliftGate'
        /// </summary>
        [Fact]
        public void HasHiliftGateTest()
        {
            // TODO unit test for the property 'HasHiliftGate'
			Assert.True(true);
        }
        /// <summary>
        /// Test the property 'IsWaterTruck'
        /// </summary>
        [Fact]
        public void IsWaterTruckTest()
        {
            // TODO unit test for the property 'IsWaterTruck'
			Assert.True(true);
        }
        /// <summary>
        /// Test the property 'HasSealcoatHitch'
        /// </summary>
        [Fact]
        public void HasSealcoatHitchTest()
        {
            // TODO unit test for the property 'HasSealcoatHitch'
			Assert.True(true);
        }
        /// <summary>
