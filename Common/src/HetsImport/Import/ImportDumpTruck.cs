    ...
    public static class ImportDumpTruck
    {
        ...
        public static void Import(PerformContext performContext, DbAppContext dbContext, string fileLocation, string systemId)
        {
            ...
            try
            {
                ...
                foreach (ImportModels.DumpTruck item in legacyItems.WithProgress(progress))
                {
                ...
                {
                    string temp = string.Format("Error saving data (Dump truck EquipmentIndex: {0}): {1}", lastEquipmentIndex, e.Message);
