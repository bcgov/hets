...
INSERT INTO public."HET_USER"
  ("USER_ID", "SURNAME", "GIVEN_NAME", "INITIALS", "SM_USER_ID", "SM_AUTHORIZATION_DIRECTORY", "GUID", "EMAIL", "ACTIVE", "DISTRICT_ID", 
   ...
   "APP_LAST_UPDATE_TIMESTAMP")
VALUES 
  (2, 'Bhargava', 'Devashish', 'DB', 'dbhargav', 'IDIR', NULL, 'devashish.bhargava@gov.bc.ca', true, 10,
   NULL, NULL, 'HETS', NOW(), 
   NULL, NULL, 'HETS', NOW());  
...
INSERT INTO public."HET_USER"
  ("USER_ID", "SURNAME", "GIVEN_NAME", "INITIALS", "SM_USER_ID", "SM_AUTHORIZATION_DIRECTORY", "GUID", "EMAIL", "ACTIVE", "DISTRICT_ID", 
   ...
   "APP_LAST_UPDATE_TIMESTAMP")
VALUES 
  (3, 'Jones', 'Chrystal', 'CJ', 'chrjones', 'IDIR', NULL, 'chrystal.jones@gov.bc.ca', true, 10,
   NULL, NULL, 'HETS', NOW(), 
   NULL, NULL, 'HETS', NOW());   
...
INSERT INTO public."HET_USER"
  ("USER_ID", "SURNAME", "GIVEN_NAME", "INITIALS", "SM_USER_ID", "SM_AUTHORIZATION_DIRECTORY", "GUID", "EMAIL", "ACTIVE", "DISTRICT_ID", 
   ...
   "APP_LAST_UPDATE_TIMESTAMP")
VALUES 
  (4, 'Test', 'Hets', 'TH', 'trhetsat', 'IDIR', NULL, 'trhetsat@gov.bc.ca', true, 10,
   NULL, NULL, 'HETS', NOW(), 
   NULL, NULL, 'HETS', NOW());     
   
ALTER SEQUENCE public."HET_USER_ID_seq" RESTART WITH 4; 
