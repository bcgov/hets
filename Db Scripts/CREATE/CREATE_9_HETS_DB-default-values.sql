...
INSERT INTO public."HET_PROVINCIAL_RATE_TYPE"
  ("RATE_TYPE", "ACTIVE", "OVERTIME", "DESCRIPTION", "IS_INCLUDED_IN_TOTAL", "IS_PERCENT_RATE",
   ...
   "APP_LAST_UPDATE_TIMESTAMP")
VALUES 
  ('LABOUR', true, false, 'Labour Rate', true, false, true, 'Weekly', 0, true,
   NULL, NULL, 'HETS', NOW(), 
   NULL, NULL, 'HETS', NOW());
...
INSERT INTO public."HET_PROVINCIAL_RATE_TYPE"
  ("RATE_TYPE", "ACTIVE", "OVERTIME", "DESCRIPTION", "IS_INCLUDED_IN_TOTAL", "IS_PERCENT_RATE",
   ...
   "APP_LAST_UPDATE_TIMESTAMP")
VALUES 
  ('REST', true, false, 'Rest Rate', false, false, false, 'Weekly', 48, false,
   NULL, NULL, 'HETS', NOW(), 
   NULL, NULL, 'HETS', NOW()); 
...
INSERT INTO public."HET_PROVINCIAL_RATE_TYPE"
  ("RATE_TYPE", "ACTIVE", "OVERTIME", "DESCRIPTION", "IS_INCLUDED_IN_TOTAL", "IS_PERCENT_RATE",
   ...
   "APP_LAST_UPDATE_TIMESTAMP")
VALUES 
  ('STANDBY', true, false, 'Standby Rate', false, false, true, 'Weekly', 0, false,
   NULL, NULL, 'HETS', NOW(), 
   NULL, NULL, 'HETS', NOW()); 
...
INSERT INTO public."HET_PROVINCIAL_RATE_TYPE"
  ("RATE_TYPE", "ACTIVE", "OVERTIME", "DESCRIPTION", "IS_INCLUDED_IN_TOTAL", "IS_PERCENT_RATE",
   ...
   "APP_LAST_UPDATE_TIMESTAMP")
VALUES 
  ('SWAMPER', true, false, 'Swamper Rate', true, false, true, 'Weekly', 0, true,
   NULL, NULL, 'HETS', NOW(), 
   NULL, NULL, 'HETS', NOW());
