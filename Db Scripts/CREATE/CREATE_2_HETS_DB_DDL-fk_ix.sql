...
--
-- Name: IX_HET_RENTAL_AGREEMENT_RATE_HET_RATE_PERIOD_TYPE_ID; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_HET_RENTAL_AGREEMENT_RATE_HET_RATE_PERIOD_TYPE_ID" ON public."HET_RENTAL_AGREEMENT_RATE" USING btree ("RATE_PERIOD_TYPE_ID");
...
ALTER TABLE ONLY public."HET_RENTAL_AGREEMENT"
    ADD CONSTRAINT "FK_HET_RENTAL_AGREEMENT_RENTAL_REQUEST_ROTATION_LIST_ID" FOREIGN KEY ("RENTAL_REQUEST_ID") REFERENCES public."HET_RENTAL_REQUEST_ROTATION_LIST"("RENTAL_REQUEST_ROTATION_LIST_ID");
