...
CREATE TABLE public."HET_RENTAL_REQUEST_SENIORITY_LIST" (
	...
	"RENTAL_REQUEST_ID" int4 NOT NULL,
	...
	"WORKING_NOW" bool NOT NULL DEFAULT false,
	"LAST_CALLED" bool NOT NULL DEFAULT false,
	"YTD_HOURS" float4 NOT NULL DEFAULT 0,
...
update "HET_RENTAL_REQUEST_SENIORITY_LIST" a
